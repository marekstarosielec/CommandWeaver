...
//        writer.WriteVariableValue(VariableScope.Command, "test", new VariableValueFactory().SingleTextValue("value"), null);
//        Assert.Single(storage.Temporary);
//        Assert.Equal("test", storage.Temporary.FirstOrDefault()?.Key);
//        Assert.Equal("value", storage.Temporary.FirstOrDefault()?.Value?.TextValue);
//    }
...
//    {
//        var storage = new ContextVariableStorage();
//        storage.Temporary.Add(new Variable { Key = "test" });
//        var writer = new ContextVariableWriter(Substitute.For<IContext>(), storage);
//        writer.WriteVariableValue(VariableScope.Command, "test", new VariableValueFactory().SingleTextValue("value"), null);
//        Assert.Single(storage.Temporary);
//        Assert.Equal("test", storage.Temporary.FirstOrDefault()?.Key);
...
//    {
//        var storage = new ContextVariableStorage();
//        storage.Temporary.Add(new Variable { Key = "test", LocationId = "locationId" });
//        storage.Session.Add(new Variable { Key = "test", LocationId = "locationId" });
//        storage.Local.Add(new Variable { Key = "test", LocationId = "locationId" });
//        var writer = new ContextVariableWriter(Substitute.For<IContext>(), storage);
//        writer.WriteVariableValue(VariableScope.Command, "test", new VariableValueFactory().SingleTextValue("value"), null);
//        Assert.Equal(3, storage.Temporary.Count);
//        Assert.Equal("locationId", storage.Temporary.FirstOrDefault()?.LocationId);
//    }
...
//        storage.Local.Add(new Variable { Key = "test", LocationId = "locationId" });
//        var writer = new ContextVariableWriter(Substitute.For<IContext>(), storage);
//        writer.WriteVariableValueOnTopLevelVariable(VariableScope.Session, "test", new DynamicValue("test value"), null);
//        Assert.Equal(2, storage.Temporary.Count);
//        Assert.Equal("test", storage.Temporary.FirstOrDefault()?.Key);
//        Assert.Equal("test value", storage.Session.FirstOrDefault()?.Value?.TextValue);
//    }
...
//        storage.Local.Add(new Variable { Key = "test", LocationId = "locationId" });
//        var writer = new ContextVariableWriter(Substitute.For<IContext>(), storage);
//        writer.WriteVariableValueOnTopLevelVariable(VariableScope.Application, "test", new DynamicValue("test value"), null);
//        Assert.Single(storage.Temporary);
//        Assert.Equal("test", storage.Temporary.FirstOrDefault()?.Key);
//        Assert.Equal("test value", storage.Temporary.FirstOrDefault()?.Value?.TextValue);
//    }
