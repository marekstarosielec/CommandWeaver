...
public record SetVariable(IVariableService variableService) : Operation
{
    ...
    {
        { "name", new OperationParameter { Description = "Name of variable to set value to.", Validation = new Validation { Required = true, AllowedType = "text" }}},
    ...
    public override Task Run(CancellationToken cancellationToken)
    {
        variableService.WriteVariableValue(
            ...
            Parameters["name"].Value.TextValue!, 
