...
public interface ICommandWeaver
{
    ...
    /// </summary>
    /// <param name="commandName">Name of command. It can consist of multiple words.</param>
    /// <param name="arguments">Arguments for command.</param>
    /// <param name="cancellationToken"></param>
    /// <returns></returns>
    Task Run(string commandName, Dictionary<string, string> arguments, CancellationToken cancellationToken);
}