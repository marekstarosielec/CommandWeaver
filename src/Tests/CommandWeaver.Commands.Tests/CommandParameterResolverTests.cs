...
public class CommandParameterResolverTests
{
    ...
    public void PrepareCommandParameters_ShouldWriteResolvedParametersToVariables()
    {
        var command = new Command
        {
            ...
            Parameters =
            [
                _resolver.GetCommandParameterAsDynamicValue(new CommandParameter { Name = new("param1"), Validation = new Validation { Required = true }}),
                _resolver.GetCommandParameterAsDynamicValue(new CommandParameter { Name = new("param2") })
            ]
        };
    ...
    public void PrepareCommandParameters_ShouldResolveFromOtherNames()
    {
        ...
        var command = new Command
        {
            ...
            Parameters =
            [
                _resolver.GetCommandParameterAsDynamicValue(new CommandParameter
                {
                    Name = new (names),
    ...
    public void PrepareCommandParameters_UsesIfNullTextValue()
    {
        ...
        var command = new Command
        {
            ...
            Parameters =
            [
                _resolver.GetCommandParameterAsDynamicValue(new CommandParameter { Name = new DynamicValue("param1"), IfNull = new DynamicValue("abc")}),
            ]
        };
    ...
    public void PrepareCommandParameters_UsesIfNullListValue()
    {
        ...
        var command = new Command
        {
            ...
            Parameters =
            [
                _resolver.GetCommandParameterAsDynamicValue(new CommandParameter { Name = new("param1"), IfNull = new DynamicValue(new List<DynamicValue>
                {
                    new ("{{abc}}"),
                    new (123)
                })}),
